...
export default function Register() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-600 via-emerald-700 to-teal-800 flex items-center justify-center px-3 sm:px-4 py-4">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3 sm:mb-4">Registration Successful! 🎉</h2>
          <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Redirecting to login...</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 flex items-center justify-center px-3 sm:px-4 py-4 sm:py-8">
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-5 sm:p-8 lg:p-12 max-w-2xl w-full">
        {/* Header */}
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">Create Lecturer Account</h1>
          <p className="text-sm sm:text-base text-gray-600">Smart Attendance System</p>
        </div>
        ...
        <div className="space-y-2.5 sm:space-y-3 mb-5 sm:mb-6">
          ...
          >
            ...
            <span className="truncate">Register with Microsoft</span>
          ...
          >
            ...
            <span className="truncate">Register with Facebook</span>
        ...
        <div className="space-y-4 sm:space-y-5">
          {/* Full Name */}
          <div>
            <label className="block text-gray-700 font-semibold mb-1.5 sm:mb-2 text-xs sm:text-sm">👤 Full Name *</label>
            <input
              type="text"
              name="fullName"
              value={formData.fullName}
              onChange={handleChange}
              className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-blue-500 bg-white text-gray-900 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-gray-700 font-semibold mb-1.5 sm:mb-2 text-xs sm:text-sm">🔒 Confirm Password *</label>
              <input
                type="password"
          ...
          {/* Department */}
          <div>
            <label className="block text-gray-700 font-semibold mb-1.5 sm:mb-2 text-xs sm:text-sm">📚 Department *</label>
            <select
              name="department"
            ...
            {errors.department && <p className="text-red-500 text-xs sm:text-sm mt-1">{errors.department}</p>}
          </div>

          {/* University */}
          <div>
            <label className="block text-gray-700 font-semibold mb-1.5 sm:mb-2 text-xs sm:text-sm">🏫 University (Optional)</label>
            <input
              type="text"
              name="university"
              value={formData.university}
              onChange={handleChange}
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-300 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-blue-500 bg-white text-gray-900"
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 sm:py-4 rounded-lg sm:rounded-xl text-base sm:text-lg font-bold hover:from-blue-700 hover:to-purple-700 transition shadow-lg disabled:opacity-50"
          >
        ...
        <div className="mt-5 sm:mt-6 text-center">
          <p className="text-sm sm:text-base text-gray-600">
            ...
            <a href="/login" className="text-blue-600 hover:text-blue-800 font-semibold underline">Login here</a>
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-md w-full p-5 sm:p-8 max-h-[90vh] overflow-y-auto">
            ...
            {errors.oauth && (
              <div className="mb-4 bg-red-50 border-l-4 border-red-500 p-2.5 sm:p-3 rounded">
                <p className="text-xs sm:text-sm text-red-700">{errors.oauth}</p>
              </div>
            )}
